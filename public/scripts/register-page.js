const renderRegisterPage = () => {
  ...
  <form method="POST" class="outline">
      ...
      <label class="register-label">Name:</label>
        <input type="message" class="input-message" name="message" placeholder="Type name" required>
</input>
    <label class="register-label">Email: </label><input type="message" class="input-message" name="email" placeholder="Type email" required></input>
  <label class="register-label">Password:</label> <input type="message" class="input-message" name="password" placeholder="Type password" required></input>
